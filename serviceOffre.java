...
public class serviceOffre {
            ...
            */
            ...
            for(Map<String,Object> obj : list){
             ...
             Offre t = new Offre();
                ...
                t.setId((int)id);
                  t.setDelai(obj.get("delai").toString());
    ...
    public ArrayList< Offre> getAllOffre(){
         String url = Statics.BASE_URL + "/offremob";
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                Offre = parseOffre (new String(req.getResponseData()));
    ...
    public boolean  Delete(int id){
       String url = Statics.BASE_URL + "/suppmobile/" +id;
    ...
    public boolean addOffre(Offre t) {
            String url = Statics.BASE_URL + "/addoffre1?Delai=" + t.getDelai()+ "&Taux=" + t.getTaux()+ "&Description=" + t.getDescription()+ "&Titre" + t.getTitre();
